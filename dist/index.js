...
import { dotFuncignoreFile, hostJson, localSettingsJson, packageJson, } from "./constants.js";
export default function azureIntegration() {
    ...
    async function writeHelperFiles() {
        await Promise.all([
            ...
            writeFile(new URL("./local.settings.json", ssrDir()), localSettingsJson, "utf8"),
    ...
    async function writeSSRFunction(notFoundContent) {
        ...
        await writeFile(new URL("./index.mjs", ssrOutputDir()), `
